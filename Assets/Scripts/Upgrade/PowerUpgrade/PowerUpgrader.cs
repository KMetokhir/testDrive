...
{
    [SerializeField] private List<PowerUpgrade> _upgrades;
    ...
    private PowerUpgrade _currentUpgrade;

    public event Action<IPowerUpgradeData> UpgradeExecuted;
    ...
    private void Upgrade()
    {
        ...
        PowerUpgrade upgrade = FindUpgrade(_carLevel.Level, nextLevelUpgrade);
    ...
    private PowerUpgrade FindUpgrade(uint carLevel, uint upgradeLevel)
    {
